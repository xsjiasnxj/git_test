...
void OLED_W_D0(uint8_t BitValue)
{
	...
	GPIO_WriteBit(OLED_CLK_PORT, OLED_CLK_PIN, (BitAction)BitValue);
}
...
void OLED_W_D1(uint8_t BitValue)
{
	...
	GPIO_WriteBit(OLED_MO_PORT, OLED_MO_PIN, (BitAction)BitValue);
}
...
void OLED_GPIO_Init(void)
{
   ...
   RCC_AHB1PeriphClockCmd(OLED_RCC_AHB1Periph_GPIOX, ENABLE);
	...
	GPIO_InitStructure.GPIO_Pin = OLED_MO_PIN;
 	GPIO_Init(OLED_MO_PORT, &GPIO_InitStructure);
